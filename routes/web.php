...
Route::middleware(['auth', 'user-access:operator'])->group(function () {
    ...
    Route::post('/posts2/tambah', [\App\Http\Controllers\PostController::class, 'tambah'])->name('posts.tambah');
    Route::get('/post2/{no_keputusan_pengadilan}/cetak_bukti', [\App\Http\Controllers\PostController::class, 'cetak_bukti'])->name('posts.cetak_bukti');
